-- ============================================================================
-- VENDORED FROM https://github.com/Dictionarry-Hub/trash-pcd
-- Regenerated by scripts/regen-ops.py. Do not edit by hand.
-- ============================================================================

-- Upstream commit: 4a9b9229096e1aaa8fceddf435a375b657c8010c
INSERT INTO tags (name) VALUES ('Accessibility (Optional)');
INSERT INTO tags (name) VALUES ('Anime');
INSERT INTO tags (name) VALUES ('Anime Optional');
INSERT INTO tags (name) VALUES ('Anime Release Groups');
INSERT INTO tags (name) VALUES ('Anime Streaming Services');
INSERT INTO tags (name) VALUES ('Anime Versions');
INSERT INTO tags (name) VALUES ('Asian Release Groups');
...
INSERT INTO tags (name) VALUES ('Audio Formats');
...
INSERT INTO tags (name) VALUES ('French Streaming Services');
...
INSERT INTO tags (name) VALUES ('Golden Rule (Optional)');
INSERT INTO tags (name) VALUES ('HDR');
INSERT INTO tags (name) VALUES ('HDR Formats');
INSERT INTO tags (name) VALUES ('HDR Optional');
INSERT INTO tags (name) VALUES ('HQ Release Groups');
INSERT INTO tags (name) VALUES ('HQ Source Groups');
INSERT INTO tags (name) VALUES ('Language');
INSERT INTO tags (name) VALUES ('Language Profiles');
...
INSERT INTO tags (name) VALUES ('Optional Streaming Services');
INSERT INTO tags (name) VALUES ('Release Type (Optional)');
INSERT INTO tags (name) VALUES ('Repacks/Proper (Required)');
INSERT INTO tags (name) VALUES ('Resolution (Optional)');
INSERT INTO tags (name) VALUES ('SQP');
INSERT INTO tags (name) VALUES ('Series Versions');
INSERT INTO tags (name) VALUES ('Standard');
INSERT INTO tags (name) VALUES ('Streaming Services');
INSERT INTO tags (name) VALUES ('UK Streaming Services');
INSERT INTO tags (name) VALUES ('Unwanted');
INSERT INTO tags (name) VALUES ('Unwanted Formats');
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('ADWeb', '^(ADWeb)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('ANDY', '^(ANDY)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('ATMOS', '\b(ATMOS|CtrlHD|W4NK3R|HQMUX|DON|3L)(\b|\d)', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('ATMOS (2)', '\bATMOS(\b|\d)', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('ATMOS (3)', '\b(ATMOS|DDPA)(\b|\d)', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('American Sign Language', '\b((WiTH)[ ._-](ASL))\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('AppleTor', '^(AppleTor)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('ArataEnc', '\b(ArataEnc)\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Archie', '^(Archie)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Arg0', '\b(Arg0)\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Ari (Radarr)', '\[Ari\]|-Ari\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Ari (Sonarr)', '^\[Ari\]|-Ari$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Audio Description', '\b((FRENCH|MULTi|WiTH|((BA?|A)SL[ ._-]and))[ ._-](AD|Audio[ ._-]Description))\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('BW', '(?<=\bS\d+(E\d+)?\b).*\b((B(lack)?[ ._-]?(out|(and|[n&])?[ ._-]?(W(hite)?|Chrome))))\b(?!$)', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Black American Sign Language', '\b(BASL)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('BlackRose', '\b(BlackRose)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('British Sign Language', '\b((WiTH)[ ._-](BSL))\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('C76', '^(C76)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('CHDWEB', '^(CHDWEB)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('CHX', '^(CHX)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('CLEANUP', '^(CLEANUP)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('CMRG', '^(CMRG)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('CNLP', '\b(CNLP)\b(?=[ ._-]web[ ._-]?(dl|rip)\b)', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('CYPHER', '^(CYPHER)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('DaddySubs', '\[Daddy(Subs)?\]|-Daddy(Subs)?$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Dolby Vision', '\b(dv|dovi|dolby[ .]?v(ision)?)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('ECLiPSE', '^(ECLiPSE)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('EVO (no WEBDL)', '(?<!\bweb[ ._-]?(dl|rip)?\b.*)-(EVO)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('EniaHD', '^(EniaHD)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('FAND', '\b(FAND)\b(?=[ ._-]web[ ._-]?(dl|rip)\b)', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('FS', '^(FS)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('HBO (Release Group)', '^(HBO)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('HDCTV', '^(HDCTV)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('HDR10+', '\b(HDR10(?=[+]|P(lus)?))', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('HDR10+ (GDH)', '\bHDR10(\+|P(lus)?\b)', 'hCAQEO/4', NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('HeavenlyOppa', '^(HeavenlyOppa)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('JKCT', '^(JKCT)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('LoveBug', '^(LoveBug)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Luvmichelle', '^(Luvmichelle)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('M@nI', '\b(M@nI)\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('MADSKY', '^(MADSKY)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('MALD', '\b(MALD)\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('MARK', '^(MARK)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('MLH', '^(MLH)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('MMR', '^(MMR)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('MagicStar', '^(MagicStar)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Mites', '\[Mites\]|-Mites$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('MrHulk', '^(MrHulk)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('NEXT', '^(NEXT)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Not Atmos Group (non-5.1)', '^(?!.*[^0-9]5[ .][0-1]\b).*\b(HQMUX|W4NK3R|DON|CtrlHD|3L)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Not Low Channel Count (Radarr)', '(?<=\b[12]\d{3}\b.*?)(?<!repac)[^0-9][1-4][ .][0-1]\b|\b(Stereo|Mono)\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Not Low Channel Count (Sonarr)', '(?<!repac)[^0-9][1-4][ .][0-1]\b|\b(Stereo|Mono)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Not Stereo', '(?<!repac)[^0-9]2[ .]0\b|\bStereo\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('OldT', '^(OldT)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('OurTV', '^(OurTV)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('PandaMoon', '^(PandaMoon)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Phanteam', '^(Phanteam)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('PiRAMiDHEAD', '^(PiRAMiDHEAD)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('PiRaTeS (no WEBDL)', '(?<!\bweb[ ._-]?(dl|rip)?\b.*)-(PiRaTeS)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('R&H', '\b(R&H)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('RBB', '^(RBB)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('RandomBytes', '^(RandomBytes)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('SAD', '\[SAD\]|-SAD$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('SH3LBY', '^(SH3LBY)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('SHiNE', '^(SHiNE)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('SYNFM', '^(SYNFM)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Stereo (Radarr)', '(?<=\b[12]\d{3}\b.*?)(?<!repac)[^0-9]2[ .]0\b|\bStereo\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Stereo (Sonarr)', '(?<!repac)[^0-9]2[ .]0\b|\bStereo\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Sylvar', '\b(Sylvar)\b', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('SyncUP', '^(SyncUP)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Taengoo', '^(Taengoo)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('TrueHD', 'True[ .-]?HD|W4NK3R|HQMUX', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('UnKn0wn (NoRemux)', '(?<!\b(remux).*?)\b(unkn0wn)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('VRV', '\b(VRV)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('Wendy', '^(Wendy)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('XiQUEXiQUE', '^(XiQUEXiQUE)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('iTsOK', '^(iTsOK)$', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('nekotan', '\b(nekotan)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('playWEB (Group)', '^(playWEB)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('playWEB (Title)', '\b(playWEB)\b', NULL, NULL);
...
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('unco', '^(unco)$', NULL, NULL);
INSERT INTO regular_expressions (name, pattern, regex101_id, description) VALUES ('unco@AvistaZ', '^(unco@AvistaZ)$', NULL, NULL);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('1.0 Mono', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('126811', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('3.0 Sound', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('4.0 Sound', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('5.1 Surround', NULL, 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('6.1 Surround', NULL, 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('7.1 Surround', NULL, 0);
...
FanSub groups that are consistent.', 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('Asian LQ', 'A collection of Asian release groups that either do not provide subtitles or are groups that cause issues during importing.', 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('Asian Tier 01', 'A collection of Asian release groups.
Tiers are organized based on whether they include internal English subtitles.
LQ Groups either do not provide subtitles or are groups that cause issues during importing.', 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('Asian Tier 02', 'A collection of Asian release groups.
Tiers are organized based on whether they include internal English subtitles.
LQ Groups either do not provide subtitles or are groups that cause issues during importing.', 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('Asian Tier 03', 'A collection of Asian release groups.
Tiers are organized based on whether they include internal English subtitles.
LQ Groups either do not provide subtitles or are groups that cause issues during importing.', 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('BR-DISK (BTN)', NULL, 0);
...
For more information, visit the Canal+ Wikipedia page.', 1);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('FAND', 'Fandango (FAND)
...
For more information, visit the Fandango Wikipedia page.', 1);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('FLUX', NULL, 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('FOD', '**Fuji Television On Demand**
...
From Wikipedia, the free encyclopedia', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('FraMeSToR', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('HDR10', '**HDR**
...
--8<-- "includes/cf-descriptions/apply-10000.md"', 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('Language: Not English', 'Language: English Only: Because it uses reverse scoring, and if you use the default scores, it will assign all releases without the English audio a score of -10000.', 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('MPEG2', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('MainFrame', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('SDR (2160p)', '**SDR**

This will prevent grabbing UHD/4k releases without HDR Formats.', 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('SDR (no WEBDL)', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('SiC', NULL, 0);
...
TVING (Korean: 티빙) is a South Korean subscription video on-demand over-the-top streaming service operated by TVING Corporation, It is a platform that streams dramas, entertainment shows, animations, exclusive television films, specials and documentaries.', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('TVer', '**TVer**

From Wikipedia, the free encyclopedia>){:target="\_blank" rel="noopener noreferrer"}
TVer Website', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('TheFarm', NULL, 0);
...
- Have retired and their releases don''t meet current quality standards
- Follow the Contributing General Guidelines.', 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('WEBDL Boost', NULL, 0);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('WKN', '**Wakanim**

From Wikipedia, the free encyclopedia', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('WiTH ASL', 'ASL (American Sign Language)

ASL is a sign language used in the United States and English-speaking Canada. It uses a one-handed alphabet and was heavily influenced by French Sign Language (LSF). ASL relies on spatial organization and facial expressions to convey meaning and grammar.', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('WiTH BASL', 'BASL (Black American Sign Language)

BASL is a dialect of ASL used primarily by Black Deaf Americans, originating from segregated schools in the South. Compared to mainstream ASL, it uses a larger signing space, more two-handed signs, and greater emotional expression.', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('WiTH BSL', 'BSL (British Sign Language)

BSL is a sign language used across the United Kingdom. It uses a two-handed alphabet and is part of the BANZSL language family, alongside Australian and New Zealand sign languages. BSL relies on body movement and hand shapes to convey meaning, and often follows a topic-comment sentence structure.', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('WiTH.AD', '**With Audio Description**

From Wikipedia, the free encyclopedia

Audio description (AD), also referred to as a video description, described video, or visual description, is a form of narration used to provide information surrounding key visual elements in a media work (such as a film or television program, or theatrical performance) for the benefit of blind and visually impaired consumers.', 1);
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('Wrong Language', NULL, 0);
...
INSERT INTO custom_formats (name, description, include_in_rename) VALUES ('x266 (Codec)', '**x266**
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('126811', '126811', 'release_group', 'radarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('2.0 Stereo', 'Stereo (Radarr)', 'release_title', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('2.0 Stereo', 'Stereo (Sonarr)', 'release_title', 'sonarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('4K Remaster', '4K', 'release_title', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('4K Remaster', 'Not 4K Resolution', 'resolution', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('4K Remaster', 'Remaster', 'release_title', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('4OD', '4OD', 'release_title', 'sonarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('4OD', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('4OD', 'WEBRIP', 'source', 'sonarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('7.1 Surround', 'Not Low Channel Count (Radarr)', 'release_title', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('7.1 Surround', 'Not Low Channel Count (Sonarr)', 'release_title', 'sonarr', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('ALL4', 'ALL4', 'release_title', 'sonarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('ALL4', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('ALL4', 'WEBRIP', 'source', 'sonarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'DemiHuman', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'FLE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'Flugel', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'LYS1TH3A', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'Moxie', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'SoM', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'sam', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 01', 'smol', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Aergia', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Arg0', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Arid', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'BlackRose', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'FateSucks', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'JOHNTiTOR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'JySzE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Kulot', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'LostYears', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Lulu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Meakes', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Orphan', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'Vodes', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'WAP', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'YURI', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'ZeroBuild', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'hchcsen', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'hydes', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 02', 'koala', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'ARC', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'BBT-RMX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'CRUCiBLE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'CUNNY', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'ChucksMux', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Cunnysseur', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Doc', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Headpatter', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Inka-Subs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'LaCroiX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Legion', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'MTBB', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Mehul', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Mysteria', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'NAN0', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'NTRX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Netaro', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Noiy', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Okay-Subs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'P9', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'PMR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'RMX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'RUDY', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'RaiN', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Sekkon', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Serendipity', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'SubsMix', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'Sylvar', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'ZR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'cappybara', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'fig', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'nekotan', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'npz', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'sgt', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 03', 'uba', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'ABdex', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Afro', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'BKC', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'BiRJU', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'CBT', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Chimera', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'DIY', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'EXP', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Foxtrot', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'IK', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Iznjie Biznjie', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'KH', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Kaleido-subs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Kametsu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Kawatare', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'LazyRemux', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'MK', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Metal', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'OZR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Pizza', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Quetzal', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Reza', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'SCY', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Shimatta', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Smoke', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Spirale', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'UDF', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'UQW', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'VULCAN', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Vanilla', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'Virtuality', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'aRMX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'derp', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'grimf', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'neko-kBaraka', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 04', 'pog42', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'AOmundson', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'ASC', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Animorphs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'B00BA', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Baws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Beatrice', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'CTR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Cait-Sidhe', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'CsS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'D4C', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Drag', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Freehold', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'GHS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Hark0N', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Holomux', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Judgement', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'MC', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'NH', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'NTRM', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'QM', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'TTGA', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Thighs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'UltraRemux', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'WBDP', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'WSE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'Yuki', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'deanzel', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'eldon', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'mottoj', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 05', 'o7', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'ANE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'Bunny-Apocalypse', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'CyC', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'Datte13', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'EJF', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'GSK_kun', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'GetItTwisted', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'Pookie', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'RASETSU', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'Starbez', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'Tsundere', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'YURASUKA', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'Yoghurt', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'iKaos', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 06', 'karios', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', '9volt', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'AC', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Almighty', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Asakura', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Asenshi', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'BlurayDesuYo', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Bolshevik', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Brrrrrrr', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Chihiro', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Commie', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Crow', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Dae', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Dekinai', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Dragon-Releases', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'DragsterPS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Exiled-Destiny', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'FFF', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Final8', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'GJM', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Geonope', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Koten_Gars', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'LCE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'NTW', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'RAI', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'REVO', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'SCP-2223', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'SEV', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Senjou', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'THORA', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'Vivid', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'iAHD', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'inid4c', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'kuchikirukia', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 07', 'orz', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'AkihitoSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'Arukoru', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'Bluray', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'DVD', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'EDGE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'EMBER', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'GHOST', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'Judas', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'Nep_Blanc', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'Prof', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'Shirσ', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime BD Tier 08', 'naiyas', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Dual Audio', 'Chinese Language', 'language', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Dual Audio', 'Dual Audio', 'release_title', 'all', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Dual Audio', 'Japanese Language', 'language', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Dual Audio', 'Not Single Language Only', 'release_title', 'all', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', '$tore-Chill', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', '0neshot', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', '224', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'A-Destiny', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AREY', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'ASW', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AceAres', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AhmadDev', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AniVoid', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Anime Chap', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Anime Land', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Anime Time', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AnimeDynastyEN', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AnimeKuro', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AnimeRG', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'AnimeTR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Animesubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Anitsu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'ArataEnc', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Ari (Radarr)', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Ari (Sonarr)', 'release_title', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'BJX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'BlackLuster', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'CBB', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'CameEsp', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Cat66', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Cerberus', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Cleo', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'CuaP', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'DARKFLiX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'DB', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'DBArabic', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'DKB', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'DP', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'DaddySubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Deadmau- RAWS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'DsunS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Emmid', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'ExREN', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'FAV', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Fish', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'FunArts', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'GERMini', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'HAV1T', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'HENiL', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'HR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Hakata Ramen', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Hall_of_C', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Hatsuyuki', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Hitoku', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'HollowRoxas', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'ICEBLUE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'JacobSwaggedUp', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Johnny-englishsubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'KEKMASTERS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'KQRM', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'KRP', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Kallango', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Kanjouteki', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Kirion', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'LoliHouse', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'M@nI', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'MD', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'MGD', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Man.K', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Maximus', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Metaljerk', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'MiniFreeza', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'MiniMTBB', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'MiniTheatre', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'MinisCuba', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Mites', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Modders Bay', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Mr. Deadpool', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'NS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'NemDiggers', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Nokou', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'NoobSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Nyanpasu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'OldCastle', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Pantsu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Pao', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Pixel', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Plex Friendly', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'PnPSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Polarwindz', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Project-gxs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'PuyaSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'QCE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'QaS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Rando235', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Ranger', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Rapta', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Raw Files', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Raze', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Reaktor', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'RightShiftBy2', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Rip Time', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'SAD', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'SEiN', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'SHFS', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'SLAX', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'SRW', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'SSA', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Salieri', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Samir755', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'SanKyuu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Sokudo', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'StrayGods', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Suki Desu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'TOPKEK', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'TeamTurquoize', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Tenrai Sensei', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'TnF', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Trix', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'U3-Web', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'UNBIASED', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'USD', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Valenciano', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'VipapkStudios', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Wardevil', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'WtF Anime', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Yabai_Desu_NeRandomRemux', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'YakuboEncodes', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'YuiSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'Yun', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'bonkai77', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'iPUNISHER', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'mal lu zen', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'mdcx', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'neoHEVC', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'phazer11', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'sekkusu&ok', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'shincaps', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'uP', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'xiao-av1', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime LQ Groups', 'youshikibi', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'AsukaRaws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Beatrice-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Daddy-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Fumi-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'IrizaRaws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Kawaiika-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Koi-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Lilith-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'LowPower-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Moozzi2', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'NC-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'NanakoRaws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'New-raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Ohys-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Pandoratv-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Raws-Maji', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'ReinForce', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Scryous-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'Seicher-Raws', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'km', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Raws', 'neko-raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'Arg0', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'Arid', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'Baws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'FLE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'LYS1TH3A', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'LostYears', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'McBalls', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'SCY', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'Setsugen', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'SoM', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'Vodes', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'WEBRIP', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'Z4ST1N', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'ZeroBuild', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'sam', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 01', 'smol', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', '0x539', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Asakura', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'BlackRose', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Cyan', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Cytox', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Dae', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Foxtrot', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'GSK_kun', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Gao', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Half-Baked', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'HatSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'MALD', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'MTBB', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Not-Vodes', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Okay-Subs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Pizza', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Reza', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Slyfox', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'SoLCE', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'Tenshi', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 02', 'WEBRIP', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 03', 'AnoZu', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 03', 'Dooky', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 03', 'Kitsune', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 03', 'SubsPlus+', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 03', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 03', 'WEBRIP', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 03', 'ZR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 04', 'Erai-Raws', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 04', 'ToonsHub', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 04', 'VARYG', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 04', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 04', 'WEBRIP', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'BlueLobster', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'GST', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'HorribleRips', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'HorribleSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'KAN3D2M', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'KiyoshiStar', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'Lia', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'NanDesuKa', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'SobsPlease', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'Some-Stuffs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'SubsPlease', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'URANIME', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'WEBRIP', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'ZigZag', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 05', 'playWEB', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', '9volt', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'Asenshi', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'Chihiro', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'Commie', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'DameDesuYo', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'Doki', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'GJM', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'Kaleido', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'Kantai', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'KawaSubs', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'Tsundere', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Anime Web Tier 06', 'WEBRIP', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('BR-DISK (BTN)', 'BR-DISK (BTN)', 'release_title', 'sonarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('BW', 'BW', 'release_title', 'sonarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Bad Dual Groups', 'C76', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Bad Dual Groups', 'OldT', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Black and White Editions', 'Blackout/B&W/Black&Chrome', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Black and White Editions', 'Darkness and Light', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Black and White Editions', 'Grayscale', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Black and White Editions', 'Monochrome', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Black and White Editions', 'No/Minus Color', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Black and White Editions', 'Noir', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Black and White Editions', 'Shush Cut', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('CNLP', 'CNLP', 'release_title', 'all', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('CNLP', 'WEBDL', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Criterion Collection', 'Bluray', 'source', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Criterion Collection', 'CC', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Criterion Collection', 'Criterion', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Criterion Collection', 'DVD', 'source', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Criterion Collection', 'Not Criterion RlsGrp', 'release_group', 'radarr', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DSCP', 'DSCP Rename', 'release_title', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DSCP', 'Discovery+', 'release_title', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DSCP', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DSCP', 'WEBRIP', 'source', 'sonarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DV (w/o HDR fallback)', 'Dolby Vision', 'release_title', 'all', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DV (w/o HDR fallback)', 'Not HDR', 'release_title', 'all', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DV (w/o HDR fallback)', 'Not Hulu', 'release_title', 'all', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DV (w/o HDR fallback)', 'Not RlsGrp', 'release_group', 'all', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DV (w/o HDR fallback)', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('DV (w/o HDR fallback)', 'WEBRIP', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Dubs Only', 'Dubbed', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Dubs Only', 'Golumpa', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Dubs Only', 'KS (Not Dual Audio)', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Dubs Only', 'KaiDubs (Not Dual Audio)', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Dubs Only', 'KamiFS', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Dubs Only', 'torenter69', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('FAND', 'FAND', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('FAND', 'WEBDL', 'source', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('FAND', 'WEBRIP', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('FUNi', 'Funimation', 'release_title', 'all', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('FUNi', 'WEBDL', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('FraMeSToR', 'FraMeSToR', 'release_group', 'radarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HBO', 'HBO', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HBO', 'HBO Rename', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HBO', 'WEBDL', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HD Bluray Tier 01', 'ATELiER', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HD Bluray Tier 01', 'Not Remux Source', 'source', 'sonarr', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HD Bluray Tier 02', 'Not Remux Source', 'source', 'sonarr', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HDR10', 'DV With HDR10 fallback', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HDR10', 'HDR', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HDR10', 'HDR10', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HDR10', 'HDR10+', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HDR10', 'HLG', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HDR10', 'PQ', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HDR10', 'RlsGrp (Missing HDR)', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HIDIVE', 'HIDIVE', 'release_title', 'sonarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HIDIVE', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('HIDIVE', 'WEBRIP', 'source', 'sonarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('IMAX', 'IMAX', 'release_title', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('IMAX', 'NOT: IMAX Enhanced', 'release_title', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('IMAX Enhanced', 'IMAX Enhanced', 'release_title', 'radarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ', 'CLEANUP', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ', 'FS', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ', 'NhaNc3', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ', 'RBB', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ', 'SyncUP', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ (Release Title)', 'BEN THE MEN', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ (Release Title)', 'Feranki1980', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ (Release Title)', 'R&H', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ (Release Title)', 'TeeWee', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('LQ (Release Title)', 'UnKn0wn (NoRemux)', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('MainFrame', '2160p', 'resolution', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('MainFrame', 'MainFrame', 'release_group', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Masters of Cinema', 'Masters of Cinema', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Masters of Cinema', 'MoC', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('NLZ', 'NLZiet', 'release_title', 'sonarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('NLZ', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('NLZ', 'WEBRIP', 'source', 'sonarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Obfuscated', 'Scrambled (Radarr)', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Open Matte', 'Open Matte', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('PCOK', 'WEBDL', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('QIBI', 'Quibi', 'release_title', 'sonarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('QIBI', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('QIBI', 'WEBRIP', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('RED', 'RED Rename', 'release_title', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('RED', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('RED', 'WEBRIP', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('RED', 'YouTube Red', 'release_title', 'sonarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Remux Tier 01', 'ATELiER', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Remux Tier 01', 'Remux Source', 'source', 'sonarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Remux Tier 02', 'Remux Source', 'source', 'sonarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Repack/Proper', 'Not Higher Version Repack/Proper', 'release_title', 'all', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Repack/Proper', 'Repack/Proper/Rerip', 'release_title', 'all', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Retags', '.VAV', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Retags', 'ORARBG', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SDR (2160p)', '2160p', 'resolution', 'all', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SDR (2160p)', 'HDR Formats', 'release_title', 'all', 1, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SDR (2160p)', 'SDR', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Scene', 'Not GERMAN (Radarr)', 'release_title', 'radarr', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Scene', 'Not INFLATE/DEFLATE (Radarr)', 'release_title', 'radarr', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Season Pack', 'Season Pack', 'release_type', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SiC', '2160p', 'resolution', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SiC', 'DV', 'release_title', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SiC', 'HDR', 'release_title', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SiC', 'SiC', 'release_title', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('SiC', 'WEBDL', 'source', 'radarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Special Edition', 'Not Extended Clip', 'release_title', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Special Edition', 'Not IMAX Edition', 'release_title', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Special Edition', 'Not Open Matte', 'release_title', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Special Edition', 'Not Theatrical', 'release_title', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Special Edition', 'Special Edition', 'release_title', 'radarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('TheFarm', 'TheFarm', 'release_group', 'radarr', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Theatrical Cut', 'Theatrical', 'release_title', 'radarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('TrueHD', 'Not Atmos Group (non-5.1)', 'release_title', 'all', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('TrueHD ATMOS', 'ATMOS', 'release_title', 'all', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('TrueHD ATMOS', 'Not 5.1 Surround', 'release_title', 'all', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('UHD Bluray Tier 02', 'HiDt', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('UHD Bluray Tier 02', 'RandomBytes', 'release_group', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('VOSTFR', 'SUBFRENCH', 'release_title', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('VOSTFR', 'VOSTFR', 'release_title', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Vinegar Syndrome', 'VS', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Vinegar Syndrome', 'VinSyn', 'release_title', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Vinegar Syndrome', 'Vinegar Syndrome', 'release_title', 'radarr', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'ABBiE', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'AJP69', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'APEX', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'CRFW', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'FLUX', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'HONE', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'KiNGS', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'Kitsune', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'MADSKY', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'NOSiViD', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'NTG', 'release_group', 'all', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'NTb', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'RAWR', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'SiC', 'release_group', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEB Tier 01', 'WEBDL', 'source', 'all', 0, 0);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEBDL Boost', 'WEBDL', 'source', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WEBDL Boost', 'WEBRIP', 'source', 'radarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WKN', 'WEB', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WKN', 'WEBDL', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WKN', 'WEBRIP', 'source', 'sonarr', 0, 0);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('WKN', 'WKN', 'release_title', 'sonarr', 0, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('Wrong Language', 'Wrong Language', 'language', 'all', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x265', 'Not Remux', 'source', 'sonarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x265', 'Remux', 'quality_modifier', 'radarr', 1, 1);
...
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x265 (no HDR/DV)', 'Not 2160p', 'resolution', 'all', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x265 (no HDR/DV)', 'Not HDR/DV', 'release_title', 'all', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x265 (no HDR/DV)', 'x265/HEVC', 'release_title', 'all', 0, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x266 (Codec)', 'Not Remux', 'source', 'sonarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x266 (Codec)', 'Remux', 'quality_modifier', 'radarr', 1, 1);
INSERT INTO custom_format_conditions (custom_format_name, name, type, arr_type, negate, required) VALUES ('x266 (Codec)', 'x|h266', 'release_title', 'all', 0, 1);
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('AUBC', 'Misc Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('Anime Dual Audio', 'Anime Optional');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('CBC', 'Misc Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('Dubs Only', 'Anime Optional');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('FOD', 'Asian Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('FreeLeech', 'Miscellaneous');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('HDR10', 'HDR Formats');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('HDR10+ Boost', 'HDR Formats');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('HFR', 'Miscellaneous');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('ITVX', 'UK Streaming Services');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('Internal', 'Miscellaneous');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('MPEG2', 'Miscellaneous');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('MULTi', 'Miscellaneous');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('MY5', 'UK Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('NOW', 'UK Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('SDR (2160p)', 'HDR Optional');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('TVING', 'Asian Streaming Services');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('TVer', 'Asian Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('U-NEXT', 'Asian Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('Uncensored', 'Anime Optional');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('Upscaled', 'Unwanted Formats');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('VC-1', 'Miscellaneous');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('VDL', 'Dutch Streaming Services');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('VIU', 'Asian Streaming Services');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('VOSTFR', 'French Audio Version');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('VP9', 'Miscellaneous');
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('VRV', 'Anime Streaming Services');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('x265', 'Miscellaneous');
...
INSERT INTO custom_format_tags (custom_format_name, tag_name) VALUES ('x266 (Codec)', 'Miscellaneous');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('3.0 Sound', '3.0ch', 'Not 3.0ch');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('4.0 Sound', '4.0ch', 'Not 4.0ch');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('6.1 Surround', '6.1 Surround', 'Not 6.1 Surround');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('7.1 Surround', '7.1 Surround', 'Not 7.1 Surround');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('ATMOS (undefined)', 'ATMOS', 'ATMOS (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('Anime Web Tier 05', 'playWEB', 'playWEB (Title)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('Bad Dual Groups', 'ZigZag', 'ZigZag (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('DD+ ATMOS', 'ATMOS', 'ATMOS (3)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('DV (Disk)', 'DV', 'Dolby Vision');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('DV Boost', 'DV', 'Dolby Vision');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('FraMeSToR', 'FraMeSToR', 'FraMeSToR (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('Generated Dynamic HDR', 'DV', 'Dolby Vision');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('HDR10', 'DV With HDR10 fallback', 'DV With HDR10 fallback');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('HDR10', 'RlsGrp (Missing HDR)', 'RlsGrp (Missing HDR)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('Hybrid', 'Hybrid', 'Not Hybrid');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('IMAX', 'NOT: IMAX Enhanced', 'IMAX Enhanced');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('RED', 'RED Rename', 'RED Rename');
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('RED', 'YouTube Red', 'YouTube Red');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('Remux Tier 01', 'FraMeSToR', 'FraMeSToR (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('SDR (2160p)', 'HDR Formats', 'HDR Formats');
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('SDR (2160p)', 'SDR', 'Not SDR');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('SDR (no WEBDL)', 'SDR', 'Not SDR');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('SiC', 'DV', 'Dolby Vision');
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('SiC', 'HDR', 'Not HDR');
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('SiC', 'SiC', 'SiC');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('Special Edition', 'Not Open Matte', 'Open Matte');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('Theatrical Cut', 'Theatrical', 'Not Theatrical');
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('TrueHD', 'ATMOS', 'ATMOS (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('WEB Tier 01', 'Kitsune', 'Kitsune (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('WEB Tier 01', 'SiC', 'SiC (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('WEB Tier 03', 'Dooky', 'Dooky (2)');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('WKN', 'WKN', 'WKN');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('x265', 'x|h265', 'x265/HEVC');
...
INSERT INTO condition_patterns (custom_format_name, condition_name, regular_expression_name) VALUES ('x266 (Codec)', 'x|h266', 'x|h266');
...
INSERT INTO condition_languages (custom_format_name, condition_name, language_name, except_language) VALUES ('Wrong Language', 'Wrong Language', 'Original', 0);
...
INSERT INTO condition_sources (custom_format_name, condition_name, source) VALUES ('SiC', 'WEBDL', 'web_dl');
...
INSERT INTO condition_sources (custom_format_name, condition_name, source) VALUES ('WKN', 'WEB', 'television');
INSERT INTO condition_sources (custom_format_name, condition_name, source) VALUES ('WKN', 'WEBDL', 'web_dl');
INSERT INTO condition_sources (custom_format_name, condition_name, source) VALUES ('WKN', 'WEBRIP', 'webrip');
...
INSERT INTO condition_sources (custom_format_name, condition_name, source) VALUES ('x266 (Codec)', 'Not Remux', 'bluray_raw');
...
INSERT INTO condition_resolutions (custom_format_name, condition_name, resolution) VALUES ('SDR (2160p)', '2160p', '2160p');
INSERT INTO condition_resolutions (custom_format_name, condition_name, resolution) VALUES ('SDR (no WEBDL)', '2160p', '2160p');
INSERT INTO condition_resolutions (custom_format_name, condition_name, resolution) VALUES ('SiC', '2160p', '2160p');
...
INSERT INTO condition_quality_modifiers (custom_format_name, condition_name, quality_modifier) VALUES ('x266 (Codec)', 'Remux', 'remux');
...
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Anime', 1, '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {absolute:000} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} {tvdb-{TvdbId}}', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Default', 1, '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - {Air-Date} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {absolute:000} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)}', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Emby IMDB', 1, '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - {Air-Date} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {absolute:000} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} [imdb-{ImdbId}]', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Emby TVDB', 1, '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - {Air-Date} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {absolute:000} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} [tvdb-{TvdbId}]', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Jellyfin TVDB', 1, '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - {Air-Date} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {absolute:000} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} [tvdbid-{TvdbId}]', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Original', 1, '{Original Title}', '{Original Title}', '{Original Title}', '{Series CleanTitleWithoutYear} {(Series Year)}', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('P2P Scene', 1, '{Series.CleanTitleYear}.S{season:00}E{episode:00}{.Episode.CleanTitle}{.Custom.Formats}{.Quality.Full}{.Mediainfo.AudioCodec}{.Mediainfo.AudioChannels}{.MediaInfo.VideoDynamicRangeType}{.Mediainfo.VideoCodec}{-Release Group}', '{Series.CleanTitleYear}.S{season:00}E{episode:00}{.Episode.CleanTitle}{.Custom.Formats}{.Quality.Full}{.Mediainfo.AudioCodec}{.Mediainfo.AudioChannels}{.MediaInfo.VideoDynamicRangeType}{.Mediainfo.VideoCodec}{-Release Group}', '{Series.CleanTitleYear}.S{season:00}E{episode:00}{.Episode.CleanTitle}{.Custom.Formats}{.Quality.Full}{.Mediainfo.AudioCodec}{.Mediainfo.AudioChannels}{.MediaInfo.VideoDynamicRangeType}{.Mediainfo.VideoCodec}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)}', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Plex IMDB', 1, '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - {Air-Date} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {absolute:000} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} {imdb-{ImdbId}}', 'Season {season:00}', 0, 4, NULL, 5);
INSERT INTO sonarr_naming (name, rename, standard_episode_format, daily_episode_format, anime_episode_format, series_folder_format, season_folder_format, replace_illegal_characters, colon_replacement_format, custom_colon_replacement_format, multi_episode_style) VALUES ('Plex TVDB', 1, '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - {Air-Date} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{[MediaInfo VideoDynamicRangeType]}{[Mediainfo VideoCodec]}{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} - S{season:00}E{episode:00} - {absolute:000} - {Episode CleanTitle:90} {[Custom Formats]}{[Quality Full]}{[Mediainfo AudioCodec}{ Mediainfo AudioChannels]}{MediaInfo AudioLanguages}{[MediaInfo VideoDynamicRangeType]}[{Mediainfo VideoCodec }{MediaInfo VideoBitDepth}bit]{-Release Group}', '{Series CleanTitleWithoutYear} {(Series Year)} {tvdb-{TvdbId}}', 'Season {season:00}', 0, 4, NULL, 5);
